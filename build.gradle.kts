...
plugins {
    ...
    kotlin("plugin.spring") version "2.0.20-RC2"
...
dependencies {
    ...
    implementation(kotlinx("coroutines-core:1.9.0-RC.2"))
    implementation(kotlinx("coroutines-reactor:1.9.0-RC.2"))
    ...
    implementation(kotlinx("coroutines-test:1.9.0-RC.2"))
}
